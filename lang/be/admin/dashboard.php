...
return [
    'heading' => 'Сардэчна запрашаем у Wyvern!',
...
',
        ...
        'intro-first-node' => [
            ...
            'button_label' => 'Стварыце першы вузел у Wyvern',
        ],
        'intro-support' => [
            'heading' => 'Падтрымка Wyvern',
            'content' => 'Дзякуй за выкарыстанне Wyvern! Гэта стала магчымым толькі дзякуючы падтрымцы вас, нашых удзельнікаў і ўсіх астатніх, хто нас падтрымлівае!',
